...
Namespace Platforms.MacCatalyst
  ...
  Public Class PlatformAudioAgent
    ...
    Public Sub PlayAudioFile(filename As String, shouldLoop As Boolean) Implements IAudioAgent.PlayAudioFile
      ...
      Catch ex As Exception
        System.Diagnostics.Debug.WriteLine($"MacCatalyst audio playback error: {ex.Message}")
      End Try
    End Sub
    ...
    Public Sub SetAudioVolume(volume As Single) Implements IAudioAgent.SetAudioVolume
      Try
        ...
        End If
      Catch ex As Exception
        System.Diagnostics.Debug.WriteLine($"MacCatalyst audio volume error: {ex.Message}")
      End Try
    End Sub
    ...
    Public Sub StopAudioPlayback() Implements IAudioAgent.StopAudioPlayback
      Try
        ...
        End If
      Catch ex As Exception
        System.Diagnostics.Debug.WriteLine($"MacCatalyst audio stop error: {ex.Message}")
      End Try
    End Sub
    ...
    Public Sub PauseAudioPlayback() Implements IAudioAgent.PauseAudioPlayback
      Try
        ...
        End If
      Catch ex As Exception
        System.Diagnostics.Debug.WriteLine($"MacCatalyst audio pause error: {ex.Message}")
      End Try
    End Sub
    ...
    Public Sub ResumeAudioPlayback() Implements IAudioAgent.ResumeAudioPlayback
      Try
        ...
        End If
      Catch ex As Exception
        System.Diagnostics.Debug.WriteLine($"MacCatalyst audio resume error: {ex.Message}")
      End Try
    End Sub
